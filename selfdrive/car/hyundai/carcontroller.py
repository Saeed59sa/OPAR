...
def process_hud_alert(enabled, fingerprint, visual_alert, left_lane,
  ...
  if left_lane_depart:
    left_lane_warning = 1 if fingerprint in (CAR.GENESIS_G90_HI, CAR.GENESIS_G80_DH, GENESIS_G70_IK) else 2
  if right_lane_depart:
    right_lane_warning = 1 if fingerprint in (CAR.GENESIS_G90_HI, CAR.GENESIS_G80_DH, GENESIS_G70_IK) else 2
